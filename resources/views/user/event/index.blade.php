    ...
    @if (session('locale') == 'en')
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Latest Events Page</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h3 class="card-title">
                                ALL EVENTS LIST
                                <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="Total Number of Event's" style="font-size: 18px; font-weight: 500;">{{ $events->count() }}</span>
                            </h3>
                            <a class="btn btn-success ml-auto" href="{{ route('user.event.create') }}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>ADD EVENT</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($events as $key=>$event)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('public/storage/event-image/'.$event->image) }}" alt="Feature-Image" width="200" height="140" class="rounded">
                                            </td>
