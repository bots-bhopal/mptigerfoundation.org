...
@section('content')
    ...
    <section class="page-banner">
        <div class="image-layer lazy-image" data-bg="url('../../public/assets/images/mptfs-imgs/Tiger_Initiative.jpg')">
        </div>
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image">
                                    <img class="lazy-image loaded"
                                        data-src="{{ asset('public/storage/awareness-image/' . $awareness->image) }}"
                                        alt="">
                                </figure>
                                <a href="{{ asset('public/storage/awareness-image/' . $awareness->image) }}"
                            ...
                            <div class="lower-content">
                                ...
                                <ul class="info clearfix">
                                    <li><span
                                            class="icon far fa-calendar"></span>{{ date('d-m-Y', strtotime($awareness->date)) }}
                                    </li>
                                    <li><span
                                            class="icon far fa-clock"></span>{{ date('h:i A', strtotime($awareness->time)) }}
                                    </li>
    ...
    <section class="related-products">
        <div class="auto-container">
            ...
            @endforeach
            @if (file_exists('public/storage/awareness-images/' . $aware))
                <div class="sec-title">
                            ...
                            <div class="inner-box">
                                <div class="image">
                                    <img class="lazy-image owl-lazy"
                                        src="{{ asset('public/storage/awareness-images/' . $aware) }}"
                                        data-src="{{ asset('public/storage/awareness-images/' . $aware) }}" alt="" />
                                    <div class="overlay-box">
                                        <ul class="option-box">
                                            <li><a href="{{ asset('public/storage/awareness-images/' . $aware) }}"
