...
@section('title', 'Downloads Category - MPTFS')
                                ...
                                <div class="inner-box wow fadeInUp" data-wow-delay="0ms">
                                    <div class="overlay-box">
                                        <div class="image-box">
                                            <figure class="image">
                                                @php
                                                    ...
                                                    $extension = pathinfo(storage_path() . '/downloads/' . $filename, PATHINFO_EXTENSION);
                                                @endphp

                                                @if ($extension == 'pdf')
                                                    <a href="{{ asset('public/storage/downloads/' . $download->original_filename) }}"
                                                        class="lightbox-image" data-fancybox="products">
                                                        <img class="lazy-image"
                                                            src="{{ asset('public/assets/images/document.jpg') }}">
                                                    </a>
                                                @endif
                                                ...
                                                <a href="{{ asset('public/storage/downloads/' . $download->original_filename) }}"
                                                    class="lightbox-image" data-fancybox="products">
                                                    <img class="lazy-image"
                                                        src="{{ asset('public/storage/downloads/' . $download->original_filename) }}"
                                                        alt="">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="lower-content">
                                            <h3>
                                                <a href="{{ asset('public/storage/downloads/' . $download->original_filename) }}"
                                                    target="_blank">{{ $download->original_filename }}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="overlay-box">
                                        <div class="image-box">
                                            <figure class="image"><a
                                                    href="{{ asset('public/storage/downloads/' . $photo->filename) }}"
                                                    class="lightbox-image" data-fancybox="products"><img
                                                        class="lazy-image"
                                                        src="{{ asset('public/storage/downloads/' . $photo->filename) }}"
                                                        alt="{{ $photo->original_filename }}"></a></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
