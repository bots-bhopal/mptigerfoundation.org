...
@section('title', 'Author List - MPTFS')
        ...
        @if (session('locale') == 'en')
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Author List Page</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-header d-flex">
                                    <h3 class="card-title">
                                        ...
                                        <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip"
                                            data-placement="top" title="Total Number of Author's"
                                            style="font-size: 18px; font-weight: 500;">{{ $authors->count() }}</span>
                                    </h3>
                                    <a href="{{ route('admin.author.view') }}" class="btn btn-sm btn-success ml-auto"><i
                                            class="nav-icon fas fa-user-plus" style="margin-right: 8px;"></i>ADD NEW
                                        AUTHOR</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            @foreach ($authors as $key => $author)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input data-id="{{ $author->id }}" class="toggle-class"
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('admin.author.edit', $author->id) }}"
                                                            class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"
                                                                style="margin-right: 5px;"></i>Edit</a>
                                                        <a href="{{ route('admin.author.changepassword', $author->id) }}"
                                                            class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"
                                                                style="margin-right: 5px;"></i>Change Password</a>

                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="deleteUser({{ $author->id }})"><i
        ...
        @if (session('locale') == 'hi')
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">लेखक लिस्ट पेज</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            ...
                            <div class="card">
                                <div class="card-header d-flex">
                                    <h3 class="card-title">
                                        लेखक लिस्ट
                                        <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip"
                                            data-placement="top" title="लेखक की कुल संख्या"
                                            style="font-size: 18px; font-weight: 500;">{{ $authors->count() }}</span>
                                    </h3>
                                    <a href="{{ route('admin.author.view') }}" class="btn btn-sm btn-success ml-auto"><i
                                            class="nav-icon fas fa-user-plus" style="margin-right: 8px;"></i>नया लेखक
                                        जोड़े</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($authors as $key => $author)
                                                    <tr>
                                                        ...
                                                        <td>{{ $author->created_at }}</td>
                                                        <td class="text-center">
                                                            <input id="toggle-demo" data-id="{{ $author->id }}"
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('admin.author.edit', $author->id) }}"
                                                                class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"
                                                                    style="margin-right: 5px;"></i>एडिट</a>
                                                            <a href="{{ route('admin.author.changepassword', $author->id) }}"
                                                                class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"
                                                                    style="margin-right: 5px;"></i>चेंज पासवर्ड</a>

                                                            <button type="button" class="btn btn-sm btn-danger"
                                                                onclick="deleteUser({{ $author->id }})"><i
                                                                    class="nav-icon fas fa-trash-alt"
                                                                    style="margin-right: 5px;"></i>डिलीट</button>
                                                            <form id="delete-form-{{ $author->id }}"
                                                                action="{{ route('admin.author.destroy', $author->id) }}"
                                                                method="POST" style="display: none;">
                                                                @csrf
