                        ...
                        <div class="col-lg-6 col-md-6 offset-lg-3 offset-md-3">
                            ...
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <form action="{{ route('admin.author.updatepassword', $user->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password"
                                                class="form-control {{ $errors->any() && $errors->first('password') ? 'is-invalid' : '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password"
                                                class="form-control {{ $errors->any() && $errors->first('confirm_password') ? 'is-invalid' : '' }}"
                                ...
                                <div class="card-body box-profile">
                                    ...
                                    <form action="{{ route('admin.author.updatepassword', $user->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password"
                                                class="form-control {{ $errors->any() && $errors->first('password') ? 'is-invalid' : '' }}"
                                                id="password" name="password" placeholder="अपना नया पासवर्ड दर्ज करें">
                                            @if ($errors->any())
                                                <p class="text-danger">{{ $errors->first('password') }}</p>
                                            @endif
                                        </div>
