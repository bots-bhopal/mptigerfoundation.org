                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{route('admin.download-category.update', $category->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{route('admin.download-category.index')}}" class="btn btn-warning float-right"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 5px;"></i>BACK</a>
                                </div>
                                <!-- /.card-footer -->
                            </form>
                        </div>
