...
<div class="content-wrapper">
    @if(session('locale') == 'en')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Download Category Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h3 class="card-title">
                                    ALL DOWNLOAD CATEGORY LIST
                                    <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="Total Number of Download Categories" style="font-size: 18px; font-weight: 500;">{{ $categories->count() }}</span>
                                </h3>
                            <a class="btn btn-success ml-auto" href="{{route('admin.download-category.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>ADD NEW CATEGORY</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @foreach ($categories as $key=>$category)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.download-category.edit', $category->id) }}" class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit" style="margin-right: 5px;"></i>Edit</a>
                                                </td>
                                                <td class="text-center">
                                                    ...
                                                    <form id="delete-form-{{ $category->id }}" action="{{ route('admin.download-category.destroy', $category->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
